...
def LG_load_train_data_split(DATA_TRAIN_PATH):
    ...
    x_9 = train[train['DER_mass_MMC'] == -999].drop(columns=['Id', 'Prediction','DER_mass_MMC','Prednum'])    
    ...
    x_2 = train[((train['PRI_jet_num'] == 2) | (train['PRI_jet_num'] == 3)) & (train['DER_mass_MMC'] != -999)].drop(columns=['Id', 'Prediction', 'PRI_jet_num','Prednum'])
     
    y = train[['Prednum', 'PRI_jet_num', 'DER_mass_MMC']]
    y_0 = y[(y['PRI_jet_num'] == 0) & (y['DER_mass_MMC'] != -999)]['Prednum'].values
    y_1 = y[(y['PRI_jet_num'] == 1) & (y['DER_mass_MMC'] != -999)]['Prednum'].values
    y_2 = y[((y['PRI_jet_num'] == 2) | (y['PRI_jet_num'] == 3)) & (y['DER_mass_MMC'] != -999)]['Prednum'].values
...
def LG_load_test_data_split(DATA_TEST_PATH):
    ...
    id_2 = test[((test['PRI_jet_num'] == 2) | (test['PRI_jet_num'] == 3)) & (test['DER_mass_MMC'] != -999)]["Id"]
    ...
    x_2 = test[((test['PRI_jet_num'] == 2) | (test['PRI_jet_num'] == 3)) & (test['DER_mass_MMC'] != -999)].drop(columns=['Id','Prediction', 'PRI_jet_num'])
